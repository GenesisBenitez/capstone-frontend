...
const userIconStyle = {color: "blue"}
    ...
    <header className="p-3 mb-3 border-bottom">
            ...
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/" className="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
                    <SiYourtraveldottv className="bi me-2" width="40" height="32" size={28}/>
                ...
                <li><a href="#" className="nav-link px-2 link-dark">Film</a></li>
                <li><a href="#" className="nav-link px-2 link-dark">History</a></li>
                </ul>
