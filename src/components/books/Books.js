...
const addBookSubmit = (e) =>{
    ...
    axios.post("http://localhost:8080/books/addBook", {
        ...
        setErrorMsg(<small className='text-danger mt-3'>Please Login to add a book</small>)
    }
};
    ...
    return(
        ...
        <div className="row justify-content-center">
            ...
            <div className='col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10'>
                    ...
                    <div className="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10" >
                        <div className="row justify-content-center">
            {books.map((book, i)=>( 
                    <div className='col-12 col-sm-12 col-md-8 col-lg-6 col-xl-4 mt-4'>
                        ...
                        <div class="card-body">
                            <div className='row'>
                                ...
                                <div className='col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6'>
                                    ...
                                    <small className='d-block fw-bold'><Link className='link-dark text-decoration-none' to={`/country/${book.country_id}`}>{book.country_name}</Link> <img src={book.flag} width="20"/></small>
                                ...
                                <div className='col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6' align='center'>
                                    <img src={book.cover} height="250" className='w-80 p-2'/>
                                </div>
                            </div>
                        </div>
                        </div>
        ...
        <div className='my Modals'>
            ...
            <div className='mymodals'>
                                <div className="modal" tabindex="-1" role="dialog" id="addAuthorModal" aria-hidden="true">
            ...
            {/* ADD BOOK MODAL */}
            <div className='mymodals'>
                                <div className="modal" tabindex="-1" role="dialog" id="addBookModal" aria-hidden="true">
                        <div className="modal-dialog modal-lg" role="document">
                            ...
                            <div className="modal-body p-5 pt-0">
                                ...
                                <div class="form-floating">
                                    <textarea style={textareaStyle} class="form-control" placeholder="Description" id="floatingTextarea2" value={description} onChange={(e)=> setDescription(e.target.value)}></textarea>
                                    <label for="floatingTextarea2">Description</label>
                                </div>
                                <div className="form-floating mb-3 mt-3">
                                    <input type="text" className="form-control rounded-4" id="floatingInput" placeholder="Release Year" value={release_year} onChange={(e)=> setRelease_year(e.target.value)}/>
                                    <label for="floatingInput"> Release Year</label>
                                </div>
                                <div className="form-floating mb-3">
                                    <select defaultValue="Select Language" className="form-select" aria-label="Select Language" value={language_id} onChange={(e)=> setLanguage_id(e.target.value)}>
                                ...
                                <div className="form-floating mb-3">
                                    <select defaultValue="Select Author" className="form-select" aria-label="Select Author" value={author_id} onChange={(e)=> setAuthor_id(e.target.value)}>
                                ...
                                <div class="form-floating">
                                    <textarea style={textareaStyle} class="form-control" placeholder="Cover" id="floatingTextarea2" value={cover} onChange={(e)=> setCover(e.target.value)}></textarea>
                                    <label for="floatingTextarea2">Cover Img URL</label>
                                </div>
                                {errorMsg}
