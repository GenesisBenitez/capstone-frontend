            ...
            if (historyTopicLike.length == 0) {
                ...
                if (historyTopicLike[0].history_topic_like == 1) {
                    return <a onClick={() => {
                        ...
                        type="button" className="text-decoration-none float-end"><BsHeartFill style={likeButtonStyle} /></a>
                    ...
                    return <a onClick={() => {
                        ...
                        type="button" className="text-decoration-none float-end"><AiOutlineHeart /></a>
                }
            }
        }
    }
        ...
        <div>
            <div className="row justify-content-center">
                <div className="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10">
                    <h4 className="display-6">Historical Topic</h4>
                    {/* <small>{historyTopic.first_name} {historyTopic.last_name}'s <span className="fw-bold">{bookhistoryTopic.name}</span></small> */}
                    <nav aria-label="breadcrumb mt-4">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/historyTopics" className="text-decoration-none link-dark">Historical Topic</a></li>
                ...
                <div className="col-10 col-sm-12 col-md-10 col-lg-10 col-xl-10 ">
                    <div className="row justify-content-center mt-4">
                        <div className="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 mt-4 order-2 order-sm-2 order-md-1 order-lg-1 order-xl-1">
                            ...
                            <small className='d-block'>Posted By: <Link className='text-decoration-none text-dark fw-bold' to={`/profile/${historyTopic.userId}`}>{historyTopic.username}</Link></small>
                            <small>{convertTime(historyTopic.created_at)}</small>
                            {getLikeButton()}
                            ...
                            {/* <small className="d-block mt-4"><GrLanguage /> {historyTopic.language}</small> */}
                        </div>
                            ...
                            <div className="modal-body p-5 pt-0">
                                <form className="" onSubmit={addHistoryTopicCommentSubmit} >
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Comment" id="floatingTextarea2" style={textareaStyle} value={comment} onChange={(e) => setComment(e.target.value)}></textarea>
